...
def constructQuery(qc):
    ...
    qc.addSelect("warmup_experiment","lowest")    
    qc.addWhereNotEqualsString("device","networkname","")    
    qc.addWhereLessThan("warmup_experiment","lowest",600)
    #qc.applyMobileClauses()
    #qc.applyLatencyClauses("143.215.131.173")
...
i+=1
orange.add(Column("ping",i,"continuous",True))
i+=1
