...
public class FileReaderUtil {
	...
	public static Long getValue_BattAtr(File f, String dischargeField) {
		...
		try {
			...
			while (line != null) 
			{
				if (line.contains("batt_current:"))
				{
					...
					try {                                   
						...
						Log.e("FileReaderUtil", nfe.getMessage(), nfe);
					}
				}
			...
			Log.e("FileReaderUtil", ex.getMessage(), ex);
		}               
	...
	public static Long getValue_OneLine(File _f, boolean _convertToMillis) {
		...
		try {
			...
			Log.e("FileReaderUtil", ex.getMessage());
			ex.printStackTrace();
		}
		...
		if (text != null)
		{
			...
			{
				Log.e("FileReaderUtil", nfe.getMessage());
				value = null;
			}
	...
	public static Long getValue_SMS() {
